# 💰 PF1 Commercial Extractor - TEST VERSION (3 PDFs)
...
# STEP 4: Process first 3 PDFs for testing
def process_test_pdfs():
    """Process first 3 PDFs and extract commercial specifications"""
    commercial_data = {}
    processed_files = 0
    max_files = 3  # Test with 3 files
    ...
    print(f"🧪 COMMERCIAL TEST MODE: Processing first {max_files} files...")
    ...
    for filepath in pdf_files:
        ...
        if processed_files >= max_files:
            print(f"🛑 Commercial test completed: Processed {max_files} files")
            break
    
    return commercial_data

# STEP 5: Create Excel file with commercial data
def create_commercial_excel(commercial_data):
    """Create Excel file with commercial specifications"""
    ...
    # Save to Excel
    excel_filename = "PF1_Commercial_Specifications_Test.xlsx"
    ...
    print(f"\n💾 Commercial Excel file created: {excel_filename}")
...
if __name__ == "__main__":
    print("💰 PF1 Commercial Extractor - TEST MODE")
    print("=" * 60)
    print("Extracting commercial specifications from 3 PDFs...")
    
    # Process PDFs and extract commercial data
    commercial_data = process_test_pdfs()
    
    if commercial_data:
        # Create Excel file
        excel_file = create_commercial_excel(commercial_data)
        
        print(f"\n✅ Commercial extraction test complete!")
        print(f"📁 File: {excel_file}")
        print(f"🎯 Ready for review and full processing!")
    else:
